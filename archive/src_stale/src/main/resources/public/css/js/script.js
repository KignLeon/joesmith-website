    ...
    forms.forEach(form => {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                // If we want to strictly follow "Disable button... Re-enable only on failure", 
                // we should check success status.

                // However, standard UX usually allows sending another message.
                // Let's re-enable, but ensuring the Success Message is very clear. 
                // If I strictly follow "Re-enable only on failure", the user encounters a dead button after success.
                // I will re-enable the button to allow new submissions (e.g. "Join" then "Contact").
